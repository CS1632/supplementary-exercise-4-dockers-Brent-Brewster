...
public class ConnectTest {
  ...
  public void dEFECT1FUNFEED() {
    ...
    js.executeScript("javascript:document.cookie = \"1=false\";document.cookie = \"2=false\";document.cookie = \"3=false\";void(0)");
    driver.findElement(By.linkText("Feed-A-Cat")).click();
    driver.findElement(By.id("catnips")).click();
    driver.findElement(By.id("catnips")).sendKeys("-6");
    driver.findElement(By.cssSelector(".btn")).click();
    assertThat(driver.findElement(By.id("feedResult")).getText(), is(not("Nom, nom, nom.")));
  }
  @Test
  public void dEFECT2FUNGREETACAT() {
    ...
    assertThat(driver.findElement(By.cssSelector("#greeting > h4")).getText(), is(not("Meow!Meow!Meow!")));
  }
  @Test
  public void dEFECT3FUNGREETACATWITHNAME() {
    driver.get("https://localhost:8080");
    js.executeScript("javascript:document.cookie = \"1=true\";document.cookie = \"2=false\";document.cookie = \"3=false\";void(0)");
    assertThat(driver.findElement(By.cssSelector(".list-group-item:nth-child(1)")).getText(), is("Rented out"));
    driver.get("https://localhost:8080greet-a-cat/Jennyanydots");
    assertThat(driver.findElement(By.cssSelector("#greeting > h4")).getText(), is(not("Meow! from Jennyanydots.")));
  }
  @Test
  public void tEST1LINKS() {
    ...
    assertEquals(vars.get("x").toString(), "https://localhost:8080reset");
  }
  @Test
  ...
  public void tEST3CATALOG() {
    ...
    assertEquals(vars.get("x").toString(), "https://localhost:8080images/cat2.jpg");
  }
  @Test
